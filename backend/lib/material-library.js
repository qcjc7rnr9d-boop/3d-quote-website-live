...
const EXPANDED_FDM_LIBRARY = [
  ...
  fdmMaterial({ key: 'tpu_98a', displayName: 'TPU 98A', aliases: ['tpu 98a', 'tpu98a', 'hard tpu', 'rigid tpu', 'semi-rigid tpu'], strength: 58, flexibility: 72, heat: 45, tags: ['Flexible'], bestFor: ['Semi-flexible brackets', 'Tough wear parts', 'Grippy functional parts'], notFor: ['Very soft parts', 'High-temperature parts'], detail: 3, outdoorUse: 3, production: [2, 3] }),
  fdmMaterial({ key: 'tpu_95a', displayName: 'TPU 95A', aliases: ['tpu', 'tpu 95a', 'tpu95a', 'thermoplastic polyurethane', 'flexible filament'], strength: 52, flexibility: 92, heat: 42, tags: ['Flexible'], bestFor: ['Phone cases', 'Gaskets', 'Grip handles'], notFor: ['Rigid structural parts', 'Fine cosmetic detail'], detail: 3, outdoorUse: 3, production: [2, 3] }),
  fdmMaterial({ key: 'tpu_95a_hf', displayName: 'TPU 95A High Flow', aliases: ['tpu 95a high flow', 'tpu high flow', 'tpu hf', 'high flow tpu', 'tpu 95a hf', 'fast tpu'], strength: 52, flexibility: 90, heat: 42, tags: ['Flexible'], bestFor: ['Faster flexible parts', 'Production TPU batches', 'Grips and bumpers'], notFor: ['Very soft elastomer parts', 'High heat'], detail: 3, outdoorUse: 3, production: [1, 2] }),
  fdmMaterial({ key: 'tpu_ams', displayName: 'TPU for AMS / AMS-Compatible TPU', aliases: ['tpu for ams', 'ams tpu', 'tpu ams', 'ams-compatible tpu', 'ams compatible tpu', 'tpu for automatic material system'], strength: 55, flexibility: 82, heat: 42, tags: ['Flexible'], bestFor: ['AMS-compatible flexible prints', 'Multimaterial flexible details', 'Grippy inserts'], notFor: ['Very soft TPU applications', 'Generic AMS profiles without testing'], detail: 3, outdoorUse: 3, production: [2, 3] }),
  fdmMaterial({ key: 'tpu_90a', displayName: 'TPU 90A', aliases: ['tpu 90a', 'tpu90a', 'flexible 90a', 'soft 90a tpu'], strength: 48, flexibility: 96, heat: 40, tags: ['Flexible'], bestFor: ['Soft bumpers', 'Wearables', 'Flexible grips'], notFor: ['Rigid structural parts', 'Fast print profiles'], detail: 3, outdoorUse: 3, production: [2, 3] }),
  fdmMaterial({ key: 'tpu_85a', displayName: 'TPU 85A', aliases: ['tpu 85a', 'tpu85a', 'soft tpu', 'very flexible tpu', 'flexible 85a'], strength: 38, flexibility: 100, heat: 38, tags: ['Flexible'], bestFor: ['Very flexible parts', 'Wearables', 'Damping pads'], notFor: ['Rigid parts', 'Tight tolerance assemblies'], detail: 3, outdoorUse: 3, production: [2, 3] }),
  fdmMaterial({ key: 'tpu_80a', displayName: 'TPU 80A', aliases: ['tpu 80a', 'tpu80a', 'super soft tpu', 'flexible 80a'], strength: 32, flexibility: 100, heat: 36, tags: ['Flexible'], bestFor: ['Soft seals', 'Cushioning parts', 'Highly flexible wearables'], notFor: ['Dimensional precision', 'Rigid or load-bearing parts'], detail: 2, outdoorUse: 3, production: [2, 4] }),
  fdmMaterial({ key: 'tpu_70a', displayName: 'TPU 70A', aliases: ['tpu 70a', 'tpu70a', 'ultra soft tpu', 'flexible 70a'], strength: 25, flexibility: 100, heat: 34, tags: ['Flexible'], bestFor: ['Ultra-soft prototypes', 'Rubber-like pads', 'Elastic test pieces'], notFor: ['Detailed prints', 'Fast print speeds'], detail: 2, outdoorUse: 3, production: [3, 5] }),
